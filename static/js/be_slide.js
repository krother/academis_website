...
var def_imges=new Array ('/media/slideshow/enthusiast_1.png','/media/slideshow/enthusiast_2.png','/media/slideshow/enthusiast_3.png','/media/slideshow/enthusiast_4.png','/media/slideshow/enthusiast_5.png','/media/slideshow/enthusiast_6.png','/media/slideshow/enthusiast_7.png','/media/slideshow/enthusiast_8.png','/media/slideshow/enthusiast_9.png','/media/slideshow/enthusiast_10.png','/media/slideshow/enthusiast_11.png','/media/slideshow/enthusiast_12.png','/media/slideshow/enthusiast_13.png');
...
var def_pichei=250; //... and this to the height of your highest pic
		...
		for(b=1;b<=emax;b++){
			...
			if(b<=1) {thez=2; thevis='visible';}
			  myhtml+="<div id='img_"+slideid+"_"+b+"' style='visibility:"+thevis+";z-index:"+thez+";position:absolute;left:0;top:0;width:"+picwid+"px;height:"+pichei+"px;'>";
				myhtml+="<img src='"+imges[(b-1)]+"' alt='slideshow'/></div>";
		}
   			myhtml+="</div>";
//show controls
		if(showcontr){
