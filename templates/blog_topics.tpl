...
<section>
  ...
  <ul class="list-spectre">
    <li class="python_basics">
      ...
      <h4><a href="/python_basics_DE">Python Übungen für Anfänger 🇩🇪</a></h4>
    </li>
    <li class="python">
      <h3><a href="/python_reference">Python 3 Reference</a></h3>
      <p>Overview of Python commands for beginners.</p>
    </li>
    <li class="data_analysis">
      <h3><a href="/data_analysis_EN">Data Analysis with Python and pandas 🇬🇧</a></h3>
      <h4><a href="/data_analysis_DE">Datenanalyse mit Python und pandas 🇩🇪</a></h4>
    </li>
    <li class="genart">
      <h3><a href="/generative_art">Graphics with Python and Numpy 🇬🇧</a></h3>
      <h4><a href="/grafik_DE">Grafik mit Python und Numpy 🇩🇪</a></h4>
    </li>
    <li class="games">
      <h3><a href="/games_EN">Game Programming in Python 🇬🇧</a></h3>
      <h4><a href="/spiele_DE">Spiele programmieren in Python 🇩🇪</a></h4>
    </li>
    <li class="python_best_practices">
      <h3><a href="/python_packages">Python Packages</a></h3>
    ...
    <li class="biochemistry">
      <h3><a href="/biopython">Biopython</a></h3>
      <p>Introduction to Biopython.</p>
    </li>
    <li class="teaching">
      <h3><a href="/teaching">Teaching Programming</a></h3>
    ...
    <li class="grant_writing">
      <h3><a href="/grant_writing">Grant Writing</a></h3>
