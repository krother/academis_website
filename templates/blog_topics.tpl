...
<section class="blog-topics">
  ...
  <ul class="list-spectre">
    ...
    <li class="python_basics">
      ...
      <h4><a href="/python_grundlagen">Python Übungen für Anfänger 🇩🇪</a></h4>
    </li>
    <li class="python">
    ...
    <li class="games">
      <h3><a href="/game_programming">Game Programming in Python 🇬🇧</a></h3>
      <h4><a href="/spiele_programmieren">Spiele programmieren in Python 🇩🇪</a></h4>
    </li>
    ...
    <li class="presenting">
      <h3><a href="/public_speaking">Presenting</a></h3>
